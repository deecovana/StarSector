...
object ExternalStrings {
    ...
    val RETRO_LIB_REQ = get("retroLibReq")
    ...
    val LIST_DIVIDER = get("listDivider")
    ...
    val GROUND_DEFENSE = get("groundDefense")
    ...
    val ARGOS_NO_BP = get("argos_noBP")
    ...
    val INTERDICTOR_TRANSDUCER_ADD = get("interdictorTransducer_add")
    val INTERDICTOR_TRANSDUCER_AFFLICT = get("interdictorTransducer_afflict")
    ...
    val GLITZ_SWITCH_ARGOS = get("glitz_argos")
    val GLITZ_SWITCH_SWAPPED = get("glitz_swapped")
    ...
    val DIVES_MILITIA_DEFENSE = get("dives_militiaDefense")
    ...
    val HQ_NO_MINING = get("unionHQ_noMining")
    ...
    val SIC_FLEET = get("sic_fleet")
    val SIC_ALL_SHIPS = get("sic_allShips")
    val SIC_ALL_FIGHTERS = get("sic_allFighters")
    val SIC_ALL_SHIPS_FIGHTERS = get("sic_allShipsFighters")
    val SIC_SALVAGING = get("sic_salvaging")
    val SIC_LOGISTICS_HULLMODS = get("sic_logisticsHullmods")

    val ROAMING_DESC = get("roaming_desc")
    val ROAMING_HL = getList("roaming_hl")
    val NOMADIC_SKILL_CARGO = get("nomadicSkill_cargo")
    val NOMADIC_SKILL_FUEL = get("nomadicSkill_fuel")
    val NOMADIC_SKILL_PERSONNEL = get("nomadicSkill_personnel")
    val NOMADIC_SKILL_FUEL_USAGE = get("nomadicSkill_fuelUsage")
    val NOMADIC_SKILL_SUPPLY_USAGE = get("nomadicSkill_supplyUsage")
    val HAULING_SKILL_BURN_BONUS = get("haulingSkill_burnBonus")
    val ROCKPIPER_ENGINEERS_INSTA_REPAIR = get("rockpiperEngineers_instaRepair")
    val ROCKPIPER_ENGINEERS_D_MODS = get("rockpiperEngineers_dModPrevention")
    val ROCKPIPER_ENGINEERS_HULL_RECOVERY = get("rockpiperEngineers_hullRecovery")
    val SALVAGING_RESOURCES = get("salvaging_resources")
    val SALVAGING_POST_BATTLE = get("salvaging_postBattle")
    val SALVAGING_CREW_LOSS = get("salvaging_crewLoss")
    val RINGER_MODS_SKILL_MOD_DESC = get("ringerMods_skillModDesc")
    val RINGER_MODS_MANEUVERABILITY = get("ringerMods_maneuverability")
    val RINGER_MODS_SLOW_BURN = get("ringerMods_slowBurn")
    val RINGER_MODS_SLOW_BURN_DESC = get("ringerMods_slowBurnDesc")
    val CREW_PROTECTION_LOSSES = get("crewProtection_losses")
    val CREW_PROTECTION_ARMOR_BONUS = get("crewProtection_armorBonus")
    val INTERCEPTION_WEAPON_RANGE = get("interception_weaponRange")
    val INTERCEPTION_FIGHTER_DAMAGE = get("interception_fighterDamage")
    val RESOLVE_SKILL_MOD_DESC = get("resolve_skillModDesc")
    val RESOLVE_CR_BONUS = get("resolve_crBonus")
    val RESOLVE_REPAIR_BONUS = get("resolve_repairBonus")
    val RESOLVE_DAMAGE_RESIST = get("resolve_damageResist")
    val HULKS_LOG_MODS = get("hulks_logMods")
    val HULKS_GENERAL = get("hulks_general")
    val HULKS_CREW = get("hulks_crew")
    val HULKS_FUEL = get("hulks_fuel")
    val HULKS_CARGO = get("hulks_cargo")
    val HULKS_BUGGED = get("hulks_bugged")
    val STORM_SKILL_MOD_DESC = get("storm_skillModDesc")
    val STORM_EBURN_BOOST = get("storm_eBurnBoost")
    val STORM_SPEED_BOOST = get("storm_speedBoost")
    val STORM_VENT_BOOST = get("storm_ventBoost")
    val STORM_DISS_BOOST = get("storm_dissBoost")
    val STORM_DISS_BOOST_COMBAT = get("storm_dissBoostInCombat")
    val STORM_OP_REDUCTION = get("storm_opReduction")
    val STORM_SPEED_RETENTION = get("storm_speedRetention")
    val STORM_SPEED_RETENTION_COMBAT = get("storm_speedRetentionInCombat")
}