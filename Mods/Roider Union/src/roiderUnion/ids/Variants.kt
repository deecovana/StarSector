...
object Variants {
    ...
    const val ARGOS_OUTDATED = "roider_argos_Outdated"
    const val ARGOS_SUPPORT = "roider_argos_Support"
    const val ARGOS_BALANCED = "roider_argos_Balanced"
    const val ARGOS_ELITE = "roider_argos_Elite"

    const val STATION_DRONE = "roider_station_drone_Standard"
}